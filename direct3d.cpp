...
bool Direct3D_Initialize(HWND hWnd)
{
	...
	*/
	...
	bd.RenderTarget[0].BlendEnable = TRUE;			//ブレンドするかしないか

	bd.RenderTarget[0].SrcBlend = D3D11_BLEND_SRC_ALPHA;
	bd.RenderTarget[0].DestBlend = D3D11_BLEND_INV_SRC_ALPHA;
	bd.RenderTarget[0].BlendOp = D3D11_BLEND_OP_ADD;			//OP(オペランド)演算子のこと
...
void Direct3D_Clear()
{
	float clear_color[4] = { 0.7f, 0.7f, 0.5f, 1.0f };
